...
public class DataCDRReporter {
    ...
    public DataCDRReporter(String reportFolder, String inputFolder, File inputFile) {
        this.baseReportFolder = reportFolder;
        this.reportFolder = determineReportFolder(inputFile, inputFolder);
        this.inputFileName = inputFile.getName();
        createReportFolder();
    }

    private String determineReportFolder(File inputFile, String inputFolder) {
        String relativePath = FileUtils.getRelativePath(inputFile, inputFolder);
