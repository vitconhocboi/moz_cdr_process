...
public class VoiceCDRReporter {
    ...
    public VoiceCDRReporter(String baseReportFolder, String voiceInputFolder, File inputFile) {
        this.baseReportFolder = baseReportFolder;
        this.reportFolder = determineReportFolder(inputFile, voiceInputFolder);
        this.inputFileName = inputFile.getName();
        createReportFolder();
    }

    private String determineReportFolder(File inputFile, String voiceInputFolder) {
        try {
            // Get relative path from voice input folder
            String relativePath = FileUtils.getRelativePath(inputFile, voiceInputFolder);
